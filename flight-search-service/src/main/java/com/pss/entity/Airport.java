...
public class Airport {
	...
	@Pattern(regexp = "^[aA-zZ ]*$", message = "Airport Name : Only alphabets are allowed.")
	private String name;

	@NotNull(message = "Airport city is required")
	@Pattern(regexp = "^[aA-zZ ]*$", message = "City : Only alphabets are allowed.")
	private String city;

	@NotNull(message = "Airport state is required")
	@Pattern(regexp = "^[aA-zZ ]*$", message = "State : Only alphabets are allowed.")
	private String state;

	@NotNull(message = "Airport country is required")
	@Pattern(regexp = "^[aA-zZ ]*$", message = "Country : Only alphabets are allowed.")
